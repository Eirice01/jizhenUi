function imgscrool(obj){
  ...
  var size=$(obj+" .banner .img li").length;

  // var size=$(obj+" .banner .img li")
  for(var j=0;j<size-1;j++){
    // console.log("-----j",j)
    $(obj+" .banner .num").append("<li style='width: 10px; height: 10px; background: #888; border-radius: 50%; display: inline-block; margin: 0 3px; cursor: pointer;'></li>");
  }

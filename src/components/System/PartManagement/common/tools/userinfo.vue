...
<template>
  <div>
    <!--<Row class="expand-row">-->
      ...
      <!--&lt;!&ndash;<span class="expand-key">性别: </span>&ndash;&gt;-->
      <!--&lt;!&ndash;<span class="expand-value">{{ row.sexName }}</span>&ndash;&gt;-->
      <!--&lt;!&ndash;</Col>&ndash;&gt;-->
      <!--<Col span="6">-->
      ...
      <!--</Col>-->
      <!--<Col span="6">-->
      <!--<span class="expand-key">入职日期: </span>-->
      <!--<span class="expand-value">{{ row.hiredate }}</span>-->
      <!--</Col>-->
      <!--<Col span="6">-->
    ...
    <Row class="expand-row">
      ...
      <!--<span class="expand-value">{{ row.cardId }}</span>-->
      <!--</Col>-->
    </Row>
    <Row>
      <Col span="24">

<template>
  <div class="notice" style="height: 100vh">
    ...
    <div style="float: left;margin-top: 20px;width: 100%;padding: 20px;">
      ...
      <div style="float: left;width: calc(100% - 180px);padding: 20px">
    ...
    <div class="content-footer" style="width: 100%;font-size: 16px;position: absolute;bottom: 0px;height: 0px;">
